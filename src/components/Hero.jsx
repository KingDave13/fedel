  ...
  return (
    ...
    items-center flex md:mb-0 ss:mb-52 mb-36'>
        ...
        >
            ...
            justify-between w-full flex md:flex-row flex-col md:gap-20 
            ss:gap-6 gap-6'>
                <motion.div variants={textVariant()}
                className='flex justify-center items-start md:gap-6
                ss:gap-6 gap-4 flex-col'
                >
                    <h1 className='text-white font-bold md:text-[45px]
                    ...
                    px-2 gap-3 justify-between items-center relative'>
                      <IoSearchOutline
                        className='text-main md:text-[20px]
                      ...
                      className='bg-primary md:text-[12px]
                        ...
                        overflow-y-auto rounded-md'>
                          {suggestions.map((suggestion) => (
                            <div
                              ...
                              className='md:p-1 ss:p-1.5 p-1 
                              hover:bg-white font-medium
                              cursor-pointer text-main md:text-[13px]
                ...
                className='flex flex-1 ss:w-full relative'>
                    <div className="absolute md:-top-52 ss:top-6 top-6 
                    z-10">
                        <TargetedSearch />
                    </div>
                </motion.div>         
