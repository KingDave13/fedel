    ...
    min-h-[250px]'>
        ...
        md:p-8 ss:p-12 p-8'>
            ...
            md:gap-5 ss:gap-5 gap-4'>
                ...
                grow5 md:text-[13px] ss:text-[15px] text-[13px] md:py-3 
